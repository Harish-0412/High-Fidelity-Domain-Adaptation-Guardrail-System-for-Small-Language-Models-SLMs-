# Medical Billing Groundedness Comparison Report

## Overview
This report compares baseline supervised fine-tuning (SFT) outputs against DPO-aligned policy outputs for the medical billing domain. The goal is to quantify how preference alignment improves citation grounding, reduces hallucination, preserves conciseness, and increases safe fallback behavior.
