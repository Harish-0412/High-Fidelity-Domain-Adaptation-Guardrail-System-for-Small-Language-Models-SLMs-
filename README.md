...
domain_slm_guardrails/
  ...
  training/
    __init__.py      # Placeholder for QLoRA and DPO
  critic/
...
```text
data/processed/medical_billing/chunks.jsonl
```
...
```text
data/indexes/medical_billing/bm25.pkl
data/indexes/medical_billing/dense_vectors.jsonl
```
...
```bash
python scripts/query_retrieval.py --domain medical_billing --query "When should modifier 25 be used?"
```
